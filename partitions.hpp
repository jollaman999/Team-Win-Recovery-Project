...
public:
	...
	bool Remove_MTP_Storage(unsigned int Storage_ID);                         // Adds or removes an MTP Storage partition                        // Flashes an image to a selected partition from the partition list
#ifdef TARGET_RECOVERY_IS_MULTIROM
